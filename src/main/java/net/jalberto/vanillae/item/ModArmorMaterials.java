...
public enum ModArmorMaterials implements ArmorMaterial {
    //reference materials in ArmorMaterials:
    ...
    EMERALD("emerald", 25, new int[]{2, 5,6,2}, 20, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.4f, 0.0f, () -> Ingredient.ofItems(Items.EMERALD)),
    RUBY("ruby", 22, new int[]{3, 6, 7, 3}, 20, SoundEvents.ITEM_ARMOR_EQUIP_DIAMOND, 1.5f, 0.1f, () -> Ingredient.ofItems(ModItems.RUBY));
